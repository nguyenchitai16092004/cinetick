                ...
                <form action="{{ route('khuyen-mai.update', $km->ID_KhuyenMai) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="MaKhuyenMai" id="MaKhuyenMai" value="{{ $km->MaKhuyenMai }}" class="form-control" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="PhanTramGiam" class="form-control" value="{{ $km->PhanTramGiam }}"
                            required min="1" max="100">
                    </div>
                    <div class="form-group mb-3">
                        <label for="NgayKetThuc">Ngày hết hạn</label>
                        <input type="date" name="NgayKetThuc" class="form-control" value="{{ $km->NgayKetThuc }}"
                            required>
                    </div>
