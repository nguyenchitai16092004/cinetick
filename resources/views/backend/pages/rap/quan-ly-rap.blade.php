                ...
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ isset($rap[0]) ? route('rap.update', $rap[0]->ID_Rap) : route('rap.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="TenRap" class="form-label fw-medium">Tên Rạp <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg rounded-3" id="TenRap" name="TenRap" 
                                    value="{{ old('TenRap', $rap[0]->TenRap ?? '') }}" required>
                            </div>

                            <div class="mb-4">
                                <label for="DiaChi" class="form-label fw-medium">Địa Chỉ <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg rounded-3" id="DiaChi" name="DiaChi" 
                                    value="{{ old('DiaChi', $rap[0]->DiaChi ?? '') }}" required>
                            </div>
