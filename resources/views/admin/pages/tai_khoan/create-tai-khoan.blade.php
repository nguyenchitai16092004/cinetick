                        ...
                        <div class="col-md-6 border-left pl-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ID_ThongTin" name="ID_ThongTin"
                                    value="{{ old('ID_ThongTin') }}" placeholder="Nhập số CCCD/CMND" required>
                            </div>

                            <div class="form-group">
                                <label for="HoTen">Họ và tên <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="HoTen" name="HoTen"
                                    value="{{ old('HoTen') }}" placeholder="Nhập họ và tên" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="GioiTinh" id="GioiTinhNam"
                                        value="1" {{ old('GioiTinh') == '1' ? 'checked' : '' }} required>
                        ...
                        <div class="col-md-6 border-left pl-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="TenDN" name="TenDN"
                                    value="{{ old('TenDN') }}" placeholder="Tên đăng nhập" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="VaiTro" name="VaiTro" required>
                                    <option value="0" {{ old('VaiTro') == '0' ? 'selected' : '' }}>Người dùng
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="TrangThai" name="TrangThai" required>
                                    <option value="1" {{ old('TrangThai') == '1' ? 'selected' : '' }}>Hoạt động
                                    </option>
                                    <option value="0" {{ old('TrangThai') == '0' ? 'selected' : '' }}>Vô hiệu
                                    </option>
                                </select>
                            </div>
                        </div>
