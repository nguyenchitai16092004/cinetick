                ...
                <form action="{{ route('khuyen-mai.update', $khuyenMai->ID_KhuyenMai) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="MaKhuyenMai" id="MaKhuyenMai" class="form-control" required
                            value="{{ old('MaKhuyenMai', $khuyenMai->MaKhuyenMai) }}" readonly>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="DieuKienToiThieu" class="form-control" required min="0"
                            ...
                            value="{{ old('DieuKienToiThieu', $khuyenMai->DieuKienToiThieu) }}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="PhanTramGiam">Phần trăm giảm (%)</label>
                        <input type="number" name="PhanTramGiam" class="form-control" required min="1"
                            max="100" value="{{ old('PhanTramGiam', $khuyenMai->PhanTramGiam) }}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="GiamToiDa">Giảm tối đa (đ)</label>
                        <input type="number" name="GiamToiDa" class="form-control" required min="0" 
                            max="1000000000" value="{{ old('GiamToiDa', $khuyenMai->GiamToiDa) }}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="SoLuong">Số lượng phiếu giảm</label>
                        <input type="number" name="SoLuong" class="form-control" required min="0" 
                            max="1000000000" value="{{ old('SoLuong', $khuyenMai->SoLuong) }}">
