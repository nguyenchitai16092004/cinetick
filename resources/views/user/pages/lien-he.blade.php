...
@section('main')
    <link rel="stylesheet" href="{{ asset('user/Content/css/lien-he.css') }}">
            ...
            <div>
                <a href="{{ $thongTinTrangWeb->Facebook }}">
                    <div class="social-box facebook">
                        <img src="{{ asset('user/Content/img/fb.png') }}" alt="Facebook" />
                ...
                <a href="{{ $thongTinTrangWeb->Instagram }}">
                    <div class="social-box instagram">
                        ...
                        <img src="{{ asset('user/Content/img/instagram.png') }}" alt="Instagram" />
                    </div>
                </a>
            </div>
    ...
    <script src="{{ asset('user/Content/js/lien-he.js') }}"></script>
