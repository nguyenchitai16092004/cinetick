...
<?php $__env->startSection('title', 'CineTick - ' . $title); ?>
<?php $__env->startSection('main'); ?>
    ...
    <div class="films-lists-wrapper">
        <?php if(Route::currentRouteName() === 'phim.dangChieu'): ?>
            <div class="header-2">
        ...
        <?php elseif(Route::currentRouteName() === 'phim.sapChieu'): ?>
            <div class="header-2">
                <h1 class="twinkle-title-pro">
                    Phim sắp chiếu
                </h1>
        ...
        <?php else: ?>
            ...
            <?php $__currentLoopData = $danhSachPhim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $phim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="pagination-wrapper">
            <?php echo e($danhSachPhim->links('pagination::bootstrap-4')); ?>

        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/user/pages/phim.blade.php ENDPATH**/ ?>