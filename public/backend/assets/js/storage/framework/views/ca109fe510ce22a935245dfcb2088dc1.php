...
.btn-ok.warning:hover { background: #d97706; }
...
.dark .notification-title { color: white; }
.dark .notification-message { color: #d1d5db; }
...
function showSuccess(message, title = null, duration = 3000) {
    showNotification('success', message, title, duration);
}
function showError(message, title = null, duration = 3000) {
    showNotification('error', message, title, duration);
}
function showWarning(message, title = null, duration = 3000) {
    showNotification('warning', message, title, duration);
}
function showInfo(message, title = null, duration = 3000) {
...
document.addEventListener('DOMContentLoaded', function() {
    <?php if(session('success')): ?>
        showSuccess(`<?php echo session('success'); ?>`);
    <?php endif; ?>
    <?php if(session('error')): ?>
        showError(`<?php echo session('error'); ?>`);
    <?php endif; ?>
    <?php if(session('warning')): ?>
        showWarning(`<?php echo session('warning'); ?>`);
    <?php endif; ?>
    <?php if(session('info')): ?>
        showInfo(`<?php echo session('info'); ?>`);
    <?php endif; ?>
    <?php if($errors->any()): ?>
...
<?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/admin/partials/notification.blade.php ENDPATH**/ ?>