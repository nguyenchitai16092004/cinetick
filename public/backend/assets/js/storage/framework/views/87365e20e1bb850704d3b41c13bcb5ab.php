...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('backend/assets/css/booking_seat.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('backend/assets/css/hoa-don.css')); ?>">
                        ...
                        <div class="col-md-8">
                            <div id="cinemaList">
                                <?php $__currentLoopData = $raps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="cinema-card" data-cinema-id="<?php echo e($rap->ID_Rap); ?>">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-film me-3 text-primary" style="font-size: 2rem;"></i>
                                            <div>
                                                <h6 class="mb-1"><?php echo e($rap->TenRap); ?></h6>
                                                <p class="text-muted mb-0"><?php echo e($rap->DiaChi); ?>
                        ...
                        <div class="col-md-8">
                            <div class="left-panel">
                                ...
                                <div class="screen-wrapper"
                                    ...
                                    <img src="<?php echo e(asset('frontend/Content/img/img-screen.png')); ?>" alt="Screen"
                                        class="screen-image">
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function layDuLieuPhim() {
            ...
            $.ajax({
                url: "<?php echo e(route('hoa-don.suat-chieu.loc-phim-theo-ngay')); ?>",
                method: 'POST',
                data: {
                    date: ngayDaChon,
        ...
        $('#applyPromo').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('hoa-don.khuyen-mai.kiem-tra')); ?>",
                type: "POST",
                data: {
        ...
        function xuatPhong() {
            ...
            $.ajax({
                url: "<?php echo e(route('hoa-don.suat-chieu.lay-phong')); ?>",
                method: 'POST',
                data: {
                    id_phong: idPhong,
        ...
        document.getElementById('btnModalConfirm').addEventListener('click', function() {
            ...
            const data = {
                _token: "<?php echo e(csrf_token()); ?>", // Bắt buộc trong Laravel
                ID_SuatChieu: trangThaiDatVe.ID_SuatChieu,
            ...
            $.ajax({
                url: "<?php echo e(route('hoa-don.payment')); ?>",
                method: "POST",
                data: data,
                success: function(res) {
                    if (res.checkoutUrl) {
        ...
        function khoiTaoSuKien() {
            ...
            if (nutTiepTheo3) nutTiepTheo3.addEventListener('click', () => {
                ...
                const isValidSelection = kiemTraGheNgoi(selectedSeatIds);
            });
            ...
            if (nutTiepTheo4) {
                nutTiepTheo4.addEventListener('click', () => {
                    ...
                    if (value === "Tiền mặt") {
                        const xacNhan = confirm("Xác nhận đã thu tiền từ khách hàng?");
                        if (!xacNhan) return;

                        // ✅ Gửi AJAX tạo hóa đơn
                        $.ajax({
                            url: "<?php echo e(route('hoa-don.store')); ?>",
                            method: "POST",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                TongTien: trangThaiDatVe.tongTien,
                                SoTienGiam: trangThaiDatVe.giamGia,
                                ID_SuatChieu: trangThaiDatVe.ID_SuatChieu,
                                PTTT: "Tiền mặt",
                            ...
                            success: function(res) {
                                window.location.href = res.redirect_url ||
                                    "<?php echo e(route('hoa-don.index')); ?>";
                            },
                            error: function(xhr) {
    ...
    <script src="<?php echo e(asset('backend/assets/js/dat-ghe.js')); ?>" defer></script>
    <script src="<?php echo e(asset('backend/assets/js/booking-seat.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/admin/pages/hoa_don/create-hoa-don.blade.php ENDPATH**/ ?>