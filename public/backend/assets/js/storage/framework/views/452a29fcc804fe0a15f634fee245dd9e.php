    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6 space-y-1">
            ...
            <li class="relative px-6 py-3">
                ...
                <a href="/admin/home"
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 
                        <?php echo e(request()->is('admin/home') ? 'text-gray-800 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400'); ?> 
            ...
            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="relative px-6 py-3">
                    <?php if(request()->routeIs($menu['route'])): ?>
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                            aria-hidden="true"></span>
                    <?php endif; ?>
                    <a href="<?php echo e(route($menu['route'])); ?>"
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 
                            <?php echo e(request()->routeIs($menu['route']) ? 'text-gray-800 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400'); ?>

                            hover:text-gray-800 dark:hover:text-gray-200">
                        <i class="fas fa-<?php echo e($menu['icon']); ?> w-5 h-5"></i>
                        <span class="ml-4"><?php echo e($menu['label']); ?></span>
                    </a>
                </li>
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="<?php echo e(route('lien-he.index')); ?>">
                    <i class="fas fa-headset"></i>
                    <span class="ml-4">Quản lý liên hệ</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <form action="<?php echo e(route('logout_admin')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 text-gray-500 dark:text-gray-400">
...
<?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/admin/partials/left-sidebar.blade.php ENDPATH**/ ?>