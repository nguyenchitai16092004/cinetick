    ...
    <section class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="text-center">
                                    <img src="<?php echo e(asset('storage/' . $banner->HinhAnh)); ?>" alt="Banner"
                                        class="img-thumbnail" style="max-height: 80px;">
                                </td>
                                <td class="fw-bold text-dark align-middle">
                                    <?php echo e($banner->TieuDeChinh); ?>

                                </td>

                                <td class="fw-bold text-dark align-middle">
                                    <?php echo e($banner->TieuDePhu); ?>

                                </td>

                                <td class="fw-bold text-dark align-middle">
                                    <?php echo e($banner->MoTa); ?>

                                </td>
                                <td class="text-truncate align-middle">
                                    <a href="<?php echo e($banner->Link); ?>" class="text-decoration-none text-primary" target="_blank">
                                        <?php echo e($banner->Link); ?>

                                    </a>
                                </td>
                                <td class="text-center align-middle">
                                    <form action="<?php echo e(route('banner.edit', $banner->id)); ?>" method="GET" class="d-inline">
            ...
            <div class="container mt-4">
                ...
                <form action="<?php echo e(route('thong-tin-trang-web.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($thongTin && $thongTin->Logo): ?>
                            <img src="<?php echo e(asset('storage/' . $thongTin->Logo)); ?>" alt="Logo" style="height: 100px;">
                        <?php else: ?>
                            <p>Chưa có logo</p>
                        <?php endif; ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($thongTin && $thongTin->Icon): ?>
                            <img src="<?php echo e(asset('storage/' . $thongTin->Icon)); ?>" alt="Icon" style="height: 100px;">
                        <?php else: ?>
                            <p>Chưa có icon</p>
                        <?php endif; ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="TenDonVi" id="TenDonVi"
                                value="<?php echo e(old('TenDonVi', $thongTin->TenDonVi ?? '')); ?>">
                            <?php $__errorArgs = ['TenDonVi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="TenWebsite" id="TenWebsite"
                                value="<?php echo e(old('TenWebsite', $thongTin->TenWebsite ?? '')); ?>">
                            <?php $__errorArgs = ['TenWebsite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Zalo" id="Zalo"
                                value="<?php echo e(old('Zalo', $thongTin->Zalo ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Hotline" id="Hotline"
                                value="<?php echo e(old('Hotline', $thongTin->Hotline ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Facebook" id="Facebook"
                                value="<?php echo e(old('Facebook', $thongTin->Facebook ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Instagram" id="Instagram"
                                value="<?php echo e(old('Instagram', $thongTin->Instagram ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Youtube" id="Youtube"
                                value="<?php echo e(old('Youtube', $thongTin->Youtube ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="Email" id="Email"
                                value="<?php echo e(old('Email', $thongTin->Email ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="DiaChi" id="DiaChi" rows="3"><?php echo e(old('DiaChi', $thongTin->DiaChi ?? '')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/admin/pages/home.blade.php ENDPATH**/ ?>