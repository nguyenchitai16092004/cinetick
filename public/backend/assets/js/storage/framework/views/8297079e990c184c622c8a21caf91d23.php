...
<?php $__env->startSection('title', 'Tạo bảng tin tức'); ?>

<?php $__env->startSection('main'); ?>
    <div class="container mt-4">
        <form action="<?php echo e(route('tin_tuc.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label>Ảnh đại diện</label>
                <br>
                <img id="preview-AnhDaiDien" src="<?php echo e(asset('images/no-image.jpg')); ?>" width="120"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/admin/pages/tin_tuc/create-tin-tuc.blade.php ENDPATH**/ ?>