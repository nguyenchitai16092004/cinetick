...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('user/Content/css/404.css')); ?>">
    <link
        ...
        <div class="error-logo">
            <a href="<?php echo e(asset('/')); ?>">
                <img src="<?php echo e($thongTinTrangWeb->Logo ? asset('storage/' . $thongTinTrangWeb->Logo) : asset('images/no-image.jpg')); ?>"
                    alt="<?php echo e($thongTinTrangWeb->TenWebsite); ?>" width="120" height="auto" />
            </a>
        </div>
        <div class="error-content">
            <div class="error-gif-wrapper">
                <img src="<?php echo e(asset('user/Content/img/error.gif')); ?>" alt="Error" class="error-gif">
            </div>
            ...
            <a href="<?php echo e(asset('/')); ?>" class="error-home-btn">
...
<?php /**PATH C:\xampp\htdocs\GitClone\cinetick\resources\views/errors/404.blade.php ENDPATH**/ ?>